require "uri"
require "httpi2/cookie_store"
require "httpi2/auth/config"
require "rack/utils"
...
module HTTPI2
  ...
  class Request
    ...
    # Sets the cookies from an object responding to `cookies` (e.g. `HTTPI2::Response`)
    # or an Array of `HTTPI2::Cookie` objects.
    ...
    # Returns the <tt>HTTPI2::Authentication</tt> object.
    def auth
    ...
    def build_query_from_hash(query)
      HTTPI2.query_builder.build(query)
    end
