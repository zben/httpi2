...
module HTTPI2
  module Auth
    ...
    class SSL
      ...
      # Sets the SSL verify mode. Expects one of <tt>HTTPI2::Auth::SSL::VERIFY_MODES</tt>.
      ...
      # Sets the SSL version number. Expects one of <tt>HTTPI2::Auth::SSL::SSL_VERSIONS</tt>.
