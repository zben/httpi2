...
module HTTPI2
  module Adapter
    ...
    # Usage:
    #
    #   HTTPI2::Adapter::Rack.mount 'application', RackApplication
    #   HTTPI2.get("http://application/path", :rack)
    class Rack < Base
      ...
      def initialize(request)
        ...
        if @app.nil?
          ...
          message += "use `HTTPI2::Adapter::Rack.mount('#{request.url.host}', RackApplicationClass)`"
