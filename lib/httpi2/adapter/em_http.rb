...
module HTTPI2
  module Adapter
    ...
    # An HTTPI2 adapter for `EventMachine::HttpRequest`. Due to limitations of
    ...
    #
    # are supported by HTTPI2 but not em-httprequest.
    #
    # In addition, some features of em-httprequest are not represented in HTTPI2
    ...
    # * multi-request
    #
    # are supported by em-httprequest but not HTTPI2.
