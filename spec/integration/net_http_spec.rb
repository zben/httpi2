...
describe HTTPI2::Adapter::NetHTTP do
  ...
  #   (see spec/httpi2/adapter/net_http_spec.rb: it "supports ntlm authentication"
  ...
  #   https://github.com/savonrb/httpi2/wiki/NTLM-Integration-Test-Plan
  #
  ...
  if ENV["NTLM"]=="external"
    context "http request via NTLM" do
      it "works with NTLM connections" do
        user = "tester"
        pass = "vReqSoafRe5O"
        request = HTTPI2::Request.new("http://ntlmtest/")
