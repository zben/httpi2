...
begin
  HTTPI2::Adapter.load_adapter(:em_http)
  ...
  describe HTTPI2::Adapter::EmHttpRequest do
    ...
    let(:adapter) { HTTPI2::Adapter::EmHttpRequest.new(request) }
      ...
      context "(for SSL client auth)" do
        ...
        it "is not supported" do
          expect { adapter.request(:get) }.
            to raise_error(HTTPI2::NotSupportedError, "EM-HTTP-Request does not support SSL client auth")
        end
      end
    end
