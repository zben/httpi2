...
HTTPI2::Adapter.load_adapter(:httpclient)

describe HTTPI2::Adapter::HTTPClient do
  let(:adapter)    { HTTPI2::Adapter::HTTPClient.new(request) }
  ...
  it "does not support NTLM authentication" do
    ...
    expect { adapter.request(:get) }.
      to raise_error(HTTPI2::NotSupportedError, /adapter does not support NTLM authentication/)
  end
